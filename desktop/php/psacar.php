				...
				<form class="form-horizontal">
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{VIN du véhicule}}
									<sup><i class="fas fa-question-circle tooltips" title="{{Renseignez le VIN ici}}"></i></sup>
								</label>
								<div class="col-sm-6">
									<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="vin" placeholder="{{VIN}}">
								</div>
							</div>
							<!-- <div class="form-group">
...
<?php include_file('desktop', 'psacar', 'js', 'psacar'); ?>
